...
class GoogleDriveManager:
    ...
    def upload_file_from_bytes(self, file_bytes, file_name, mime_type, folder_name=None):
        ...
        try:
            ...
            direct_image_url = self.get_direct_image_url(file_id)
            direct_download_url = self.get_direct_download_url(file_id)
            
            print(f"✅ File uploaded: {file_name}")
            print(f"🖼️ Direct image URL: {direct_image_url}")
    ...
    def get_direct_image_url(self, file_id, size='w500'):
        """Get direct image URL for HTML display
        Args:
            file_id: Google Drive file ID
            size: Image size - 'w100', 'w200', 'w500', 'w1000', etc.
        """
